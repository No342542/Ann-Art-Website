...
- **Edit** — **click a photo** to open its panel: title, date, **category bucket**
  (Zentangle / Procreate / Pencil / Color Pencil), and a comment. Download it from there too.
...
The address `http://127.0.0.1:8090/admin/` just means *this computer*, so there's
